...
export const metadata = {
  title: 'ProtectedPay | Secure Crypto Transfers on Mantle',
  description: 'Secure crypto transfers, group payments, and smart savings on the Mantle blockchain',
  keywords: 'crypto, payments, blockchain, Mantle, DeFi, secure transfers, group payments',
